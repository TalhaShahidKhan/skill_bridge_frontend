    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <header>
        ...
        <p className="text-gray-500 font-medium font-outfit">
          See feedback you&apos;ve shared about your learning experiences.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {loading ? (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 border border-blue-100 relative overflow-hidden shrink-0">
                    ...
                    <div className="flex gap-0.5">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <Star
                          key={star}
                          className={`w-5 h-5 ${star <= review.rating ? "fill-orange-400 text-orange-400" : "text-gray-200"}`}
                        />
                      ))}
                    </div>
                  </div>
            ...
            <div className="bg-white p-20 rounded-2xl border border-dashed border-gray-200 text-center">
              ...
              <p className="text-gray-500 font-medium max-w-xs mx-auto mb-6">
                Share your learning experience after your sessions to help other
                students.
              </p>
            </div>
          )}
        ...
        <div className="space-y-6">
          <div className="bg-linear-to-br from-orange-400 to-orange-500 p-8 rounded-2xl text-white shadow-xl shadow-orange-100 relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:scale-150 transition-transform duration-700">
              <Star className="w-32 h-32" />
            </div>
            <Award className="w-10 h-10 text-orange-100 mb-4" />
            <h3 className="text-2xl font-black mb-1">Your Impact</h3>
            <p className="text-sm text-orange-50 font-semibold mb-6">
              Your reviews help tutors improve and others learn.
            </p>
            <div className="text-5xl font-black text-white">
              {reviews.length}
            </div>
            <div className="text-xs text-orange-100 font-bold uppercase tracking-widest mt-1">
              Total reviews shared
            </div>
          </div>
